...
- `Assets/00~09_*`는 로컬 전용 영역입니다. 현재 플러그인, 비주얼,
  오디오, 씬, 설정, 런타임 에셋, 프리팹, 복구 자료를 분리해 두며
  Git에 커밋하지 않습니다. 비주얼은 `02_Visual` 아래 `Sprite`와
  `VFX`, 오디오는 `03_Audio` 아래 `SFX`와 `Music`으로 분류합니다.
