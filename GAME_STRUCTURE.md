...
카드용 공간 서비스는 대원과 적의 실제 월드 위치를 코어·안쪽·외곽·방어선 구역으로 판정한다. 대상 주변 적, 지정 적 뒤편의 적, 방어선에 도달한 적, 최근 5초 안에 코어를 공격한 적을 선택할 수 있다. 카드 연산은 대원을 코어 방향·외곽 방향·외곽 구역·지정 지점·적 측면으로 이동하거나 두 대원의 위치를 교환하고, 적을 지정 지점으로 끌어당길 수 있다. 끌어당긴 적도 이동 경로의 충돌을 검사하여 다른 적과 완전히 겹치지 않는다.
