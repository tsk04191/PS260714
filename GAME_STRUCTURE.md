...
- 적과 캐릭터 SD의 원본 좌우 방향은 각 전용 에디터의 좌·우 버튼으로 저작한다. 적은 항상 보호막 중심을 바라보고, 캐릭터는 가장 최근 이동·위치 교체·공격·스킬 등 대상이 있는 행동의 방향을 바라본다. 자기 자신 또는 대상이 없는 행동은 기존 방향을 유지한다.
...
대원 이동이 무료인 조작 규칙에 맞춰 C042와 C061~C067의 아군 이동 효과를 방호·기본 공격 준비·다음 공격 연계로 교체했다. C070은 구역 배치 조건 대신 모든 적 Opening과 전원 공격 준비를 사용하며, C034·C086의 추가 보호막 조건도 위치에서 코어·대상 저체력 조건으로 변경했다. C068 영역과 C069 적 끌어당김은 유지한다.
...
| 던전 상점 | 0 | 코드만 존재 |
| 로컬라이제이션 문자열 | CSV 694 / 런타임 694 | 한국어·영어 생성 테이블 갱신 완료 |
...
2. 실제 2.5D 전장에서 12명·36명·100명 배치를 만들어 군중 간격, 큰 적의 부분 겹침, 체력바 가독성, 전열 사망 후 전진과 원거리 적의 후방 공격을 확인한다.
